                    ...
                    <View >
                        {
                            [
                                ...
                                <PressableCard shadow="0" key={`${item.name}_settings`} style={{ ...styles.item, backgroundColor: "white" }}>
                                    <TouchableOpacity key={`${item.name}_settings`} onPress={async () => {
                                        if (item.routeName) {
                                            const supported = await Linking.canOpenURL(item.routeName);
                                        ...
                                        <Box key={`${item.name}_settings`} rounded="sm" style={{ flexDirection: 'row', width: '95%' }}>
                                            <Text style={{ marginLeft: 7 }}>
                                                {item.name} {item.iconName && <FontAwesome name={item.iconName} size={22} color="blue" />}
                                            </Text>
                                        </Box>
                                    </TouchableOpacity>
                                </PressableCard>
